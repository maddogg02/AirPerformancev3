  ...
  const handleComplete = async () => {
    ...
    try {
      const profileData: Partial<UserProfile> = {
        ...
        skillLevel: skillLevel as '3' | '5' | '7' | '9',
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={rank} onValueChange={(value) => setRank(value as Rank)}>
                    <SelectTrigger className="bg-background" data-testid="select-setup-rank">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    className="bg-background"
                    maxLength={4}
                    data-testid="input-setup-afsc-prefix"
                  />
                ...
                <div className="space-y-2">
                  ...
                  {afscLoading ? (
                    ...
                    <Select value={selectedAfsc} onValueChange={setSelectedAfsc}>
                      <SelectTrigger className="bg-background" data-testid="select-setup-afsc">
                    ...
                    <div className="text-center p-4 text-muted-foreground">
                      ...
                      <Button 
                        ...
                        className="mt-2"
                        data-testid="button-try-different-prefix"
                      >
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <Select value={skillLevel} onValueChange={setSkillLevel}>
                    <SelectTrigger className="bg-background" data-testid="select-setup-skill-level">
